...
<form id="companyForm" method="post" class="form-horizontal" role="form" action="<%=request.getContextPath()%>/control/company/save">
...
<script type="text/javascript">
	...
	$('#backButton').on("click",  function(e) {
		e.preventDefault();
		get('<%=request.getContextPath()%>/control/company/list');
	});
</script>
